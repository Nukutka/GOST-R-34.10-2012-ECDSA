...
namespace ECDSA
{
    ...
    public static class Streebog
    {
        ...
        /// <summary>
        /// Вычисляет следующий итерационный ключ
        /// </summary>
        /// <param name="K">Предыдущий итерационный ключ</param>
